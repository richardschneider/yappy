...
function upgrade(r) {
    ...
    if (r1.services) {
        r1.services.forEach(s => r1.service[s.moduleName] = r1.service[s.moduleName] || merge(s, {}));
    }
    r1.services = undefined;
    defaults.services.forEach(s => r1.service[s.moduleName] = r1.service[s.moduleName] || merge(s, {}));

    return r1;
}

module.exports = {
    schema: schema('someone who owns and manages part of the yappy cloud', {
        name: Array.of(text),
        domain: subdomain,
