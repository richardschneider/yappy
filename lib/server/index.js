...
app.use(sally.express({
    user: req => req.user ? req.user.email : 'anonymous',
    prefix: './logs/yappy-'
}));
...
app.use(cache({
    '/api/media/*/content': 'max-stale=31536000', // media views are worm
...
app.use(require('./resource-cache'));
